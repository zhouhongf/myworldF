...
@Component({
  selector: 'app-show-social-mine',
  templateUrl: './show-social-mine.component.html',
  styleUrls: ['./show-social-mine.component.scss'],
})
export class ShowSocialMineComponent implements OnInit {
  @ViewChild('socialMineHeader', {static: false}) header;
  ...
  constructor(private baseService: BaseService, private storage: Storage, private router: Router, private route: ActivatedRoute) {
  }
  ...
  getData() {
    ...
    const params = {pageSize: this.pageSize, pageIndex, userWid: this.theUserWid};
