...
export class ChatMessage {
    ...
    link: string;
    ackTime: number;
    constructor(fromName: string, toName: string, content: string, type?: string, sendTime?: number, id?: string, link?: string, ackTime?: number) {
...
export class ContactTag {
    ...
    constructor(name: string, nums: number, order: number, messages: number) {
        this.name = name;
        this.nums = nums;
        this.order = order;
...
export class Friend {
    ...
    constructor(wid: string, avatar: string, nickname: string, phoneNumber?: string, displayName?: string, pinyinName?: string, tag?: string, messageNum?: number) {
        this.wid = wid;
        this.avatar = avatar;
...
export const playerTypeData = [
    { value: 'ADMIN_SUPER' },
    { value: 'USERS_CLIENT' },
    { value: 'USERS_STUDENT' },
];

export const adminPowerData = [
    { value: '超级管理员' },
    { value: '文字管理员' },
    { value: '认证管理员' }
];
...
export const offerData = [
    {name: '银行理财', value: 'WEALTH'},
    {name: '个人贷款', value: 'LOANPERSON'},
    {name: '公司贷款', value: 'LOANCOMPANY'}
];

export const writingTypeData = [
    {value: '规则协议'},
    {value: '公司新闻'},
    {value: '哲学随笔'},
    {value: '技术随笔'},
